...
class HomeFeedWebViewController: UIViewController ,WKNavigationDelegate,WKUIDelegate , SFSafariViewControllerDelegate{

    @IBOutlet weak var lottiSubView: UIView!
    @IBOutlet weak var lottiView: UIView!
    @IBOutlet weak var containerView: UIView!
    var keyboardShow = false
    var url = "https://www.modooclass.net/class/feed"
...
extension HomeFeedWebViewController:WKScriptMessageHandler {
...
extension HomeFeedWebViewController:UIScrollViewDelegate{
