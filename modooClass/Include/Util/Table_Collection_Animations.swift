...
enum AnimationFactory {
    ...
    static func makeFadeCollection(duration: TimeInterval, delayFactor: Double) -> CollectionAnimation {
        return { cell, indexPath, _ in
            cell.alpha = 0
    ...
    static func makeMoveUpWithBounceCollection(rowHeight: CGFloat, duration: TimeInterval, delayFactor: Double) -> CollectionAnimation {
        return { cell, indexPath, tableView in
            cell.transform = CGAffineTransform(translationX: 0, y: rowHeight)
    ...
    static func makeSlideInCollection(duration: TimeInterval, delayFactor: Double) -> CollectionAnimation {
        return { cell, indexPath, tableView in
            cell.transform = CGAffineTransform(translationX: tableView.bounds.width, y: 0)
    ...
    static func makeMoveUpWithFadeCollection(rowHeight: CGFloat, duration: TimeInterval, delayFactor: Double) -> CollectionAnimation {
        return { cell, indexPath, tableView in
            cell.transform = CGAffineTransform(translationX: 0, y: rowHeight / 2)
            cell.alpha = 0
